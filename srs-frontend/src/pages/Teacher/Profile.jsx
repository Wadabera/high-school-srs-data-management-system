...
import { Camera, Image as ImageIcon, User, Mail, Phone, BookOpen, Layers, Loader2, Award } from 'lucide-react';
      ...
      <div className="profile-details-grid">
        <div className="info-card">
          ...
          <div className="info-item">
            ...
            <span className="info-value">#{profile.teacherId}</span>
          </div>
          <div className="info-item">
        ...
        <div className="info-card">
          <h3 style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '25px', fontSize: '1.5rem' }}>
            <Award size={24} /> Professional Info
          </h3>
          <div className="info-item">
          ...
          <div className="info-item">
            <span className="info-label">Main Grade</span>
            <span className="info-value">Grade {profile.grade}</span>
          </div>
          <div className="info-item">
            <span className="info-label">Assigned Classes</span>
            <span className="info-value">{profile.classes?.join(', ')}</span>
          </div>
          <div className="info-item">
